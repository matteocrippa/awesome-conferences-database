...
def output_header(j)
  ...
  o << "## 📱 Mobile Apps\n\n"
  o << "We developed also 2️⃣ two mobile apps to stay always updated, thanks to 💌 push notifications, feel free to download them from 🍏 iOS and 🤖 Play store, link below:\n\n"
